...
public class WindZone : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if(other.tag == "Player")
        {
            KaijuMovement.singleton.activateRagdoll = true;
            KaijuMovement.singleton.ActivateRagdoll(KaijuMovement.singleton.activateRagdoll);
        }
    }
